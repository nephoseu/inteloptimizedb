...
variable "db_parameters" {
  type = object({
    postgres = optional(object({
      #disabled custom temp_buffers as of 5th Jan 2024 by Beny
      #temp_buffers = optional(object({
      #  value        = optional(string, 4096 * 1024 / 8) #default 8MB
      #  apply_method = optional(string, "immediate")
      #}))
      work_mem = optional(object({
        value        = optional(string, 1664) #default 4MB #total instance memory * 0.25/max_conn
        apply_method = optional(string, "immediate")
      }))
      maintenance_work_mem = optional(object({
        value        = optional(string, "{DBInstanceClassMemory/65536}") #default 128291kB = 128 MB #Total RAM * 12.5%
        apply_method = optional(string, "immediate")
      }))
      ...
      min_wal_size = optional(object({
        value        = optional(string, "256") #default 192MB
        apply_method = optional(string, "immediate")
      }))
      max_wal_size = optional(object({
        value        = optional(string, "6144") #default 2048 MB ##### custom 6GB
        apply_method = optional(string, "immediate")
      }))
      #checkpoint_warning = optional(object({
      #  value        = optional(string, 1 * 60 * 60) #3600 #default 5 mins #######
      #  apply_method = optional(string, "immediate")
      #}))
      ...
      effective_cache_size = optional(object({
        value        = optional(string, "{DBInstanceClassMemory/10922}") ####### ## formula 75% of instance memory
        apply_method = optional(string, "immediate")
      }))
      ...
      autovacuum_vacuum_cost_limit = optional(object({
        value        = optional(string, "3000") #default is 200
        apply_method = optional(string, "immediate")
      }))
      vacuum_freeze_min_age = optional(object({
        value        = optional(string, "10000000") #default is 50000000
        apply_method = optional(string, "immediate")
      }))
      max_connections = optional(object({
        value        = optional(string, "256") #default is 840
      ...
      shared_buffers = optional(object({
        ...
        value        = optional(string, "{DBInstanceClassMemory/20480}")
        #value        = optional(string, 64 * 80 * 1024 * 1024 / 800)
        apply_method = optional(string, "pending-reboot")
      }))
      ...
      max_worker_processes = optional(object({
        value        = optional(string, "{DBInstanceVCPU*2}") #cpu * 2
        apply_method = optional(string, "pending-reboot")
      }))
      wal_buffers = optional(object({
        value        = optional(string, "-1") #default is 61136kB
        apply_method = optional(string, "pending-reboot")
      }))
      ...
      autovacuum_max_workers = optional(object({
        value        = optional(string, "10") #default is 3
        apply_method = optional(string, "pending-reboot")
      }))
      autovacuum_freeze_max_age = optional(object({
        value        = optional(string, "750000000") #default is 200000000
        apply_method = optional(string, "pending-reboot") 
      }))
    }))
  })
